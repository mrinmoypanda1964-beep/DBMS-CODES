...
UPDATE EMP SET HIREDATE = STR_TO_DATE('2020-01-01', '%Y-%m-%d') WHERE EMPNO = 101;
UPDATE EMP SET HIREDATE = STR_TO_DATE('2021-06-15', '%Y-%m-%d') WHERE EMPNO = 102;
UPDATE EMP SET HIREDATE = STR_TO_DATE('2019-03-10', '%Y-%m-%d') WHERE EMPNO = 103;
